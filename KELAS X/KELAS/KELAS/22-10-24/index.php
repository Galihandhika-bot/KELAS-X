...
$nama = "Galih Andhika  <br> Budiyatna";
$judul = "IT SUPPORT";
$pengenalan = " siswa SMKN 2 Buduran yang<br> mampu bekerja dalam tim<br> cepat dan memiliki <br>keterampilan sebagai leader <br> Memiliki pengalaman<br> magang sebagai IT Helper di <br> beberapa perusahaan";
...
$data_pribadis = ["Tempat,Tanggal Lahir", "SIDOARJO,23 AGUSTUS 2008", "Alamat", "JL.PERINTIS III NO.38 RT.4 RW.1 PULUNGAN SEDATI", "Nomor Telephone", "082142437115", "Jenis Kelamin", "Laki-Laki", "Agama", "Islam", "Kewarga Negaraan", "Indonesia", "Email", "galihandhika23@gmail.com"]
...
<body>
    <div class="container">
        <div class="foto">
            <img src="C:\KELAS X\KELAS\KELAS\22-10-24\foto.jpg" alt="foto saya">
        </div>
        <div class="nama">
            <h1><?php echo $nama ?></h1>
            <div class="garis"></div>
        ...
        <div class="isi-kontak">
            <div class="container-gambar1">
                <img src="C:\KELAS X\KELAS\KELAS\22-10-24\telp.png" alt="gambar telepon">
                <p><?php echo $kontak[0] ?></p>
            </div>
            <div class="container-gambar2">
                <img src="C:\KELAS X\KELAS\KELAS\22-10-24\ig.jpeg" alt="gambar ig">
